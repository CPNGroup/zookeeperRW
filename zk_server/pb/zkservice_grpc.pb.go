...
type ZkServiceClient interface {
	Get(ctx context.Context, in *Path, opts ...grpc.CallOption) (*Message, error)
	Set(ctx context.Context, in *PathAndData, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *zkServiceClient) Get(ctx context.Context, in *Path, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
func (c *zkServiceClient) Set(ctx context.Context, in *PathAndData, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/pb.ZkService/Set", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ZkServiceServer interface {
	Get(context.Context, *Path) (*Message, error)
	Set(context.Context, *PathAndData) (*Message, error)
...
func (UnimplementedZkServiceServer) Get(context.Context, *Path) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedZkServiceServer) Set(context.Context, *PathAndData) (*Message, error) {
...
func _ZkService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZkServiceServer).Get(ctx, req.(*Path))
	}
	return interceptor(ctx, in, info, handler)
}

func _ZkService_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PathAndData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ZkServiceServer).Set(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ZkService/Set",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZkServiceServer).Set(ctx, req.(*PathAndData))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ZkService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Set",
			Handler:    _ZkService_Set_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pb/zkservice.proto",
}
